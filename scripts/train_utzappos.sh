...
# 1. 修改日志输出路径，归类到 zappos 文件夹下
#SBATCH --output=logs/point2/zappos/train/p2-%j.out
#SBATCH --error=logs/point2/zappos/train/p2-%j.err
...
# --- 1. 数据集软链接配置 (已按您的说明忽略/假定已完成) ---
DATA_ROOT="/home/bingxing2/home/scx6d4e/run/xuanzhenzhen/Base/data"

# --- 2. 预训练权重配置 (已按您的说明忽略/假定已完成) ---

# --- 3. 训练参数配置 ---
# 2. 将配置文件指向 UT-Zappos 的 ViT-L/14 配置
...
echo ">>> Start Training Dual-Branch Baseline | Dataset: UT-Zappos | Config: ${CONFIG} | Start Layer: ${ADAPTER_START_LAYER} <<<"
